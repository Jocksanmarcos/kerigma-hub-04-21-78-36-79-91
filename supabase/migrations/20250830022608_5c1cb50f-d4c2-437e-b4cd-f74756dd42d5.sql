...
VALUES ('Discipulado Nível 1: Fundamentos da Fé', 'Uma jornada pelos pilares essenciais da fé cristã, ideal para novos convertidos e membros que desejam fortalecer suas bases.', 'publicado', 500, 'Formação Espiritual', 'Básico', true)
...
INSERT INTO public.cursos (nome, descricao, status, pontos_xp_recompensa, categoria, nivel, ativo)
VALUES ('Evangelismo Intencional e Impactante', 'Aprenda a compartilhar sua fé de forma natural, relevante e poderosa no seu dia a dia.', 'publicado', 750, 'Evangelismo', 'Intermediário', true)
RETURNING id INTO curso_id_atual;
...
INSERT INTO public.cursos (nome, descricao, status, pontos_xp_recompensa, categoria, nivel, ativo)
VALUES ('Panorama Bíblico: Uma Viagem de Gênesis a Apocalipse', 'Entenda a grande narrativa da Bíblia, conectando os livros, as alianças e o plano de Deus para a humanidade.', 'publicado', 1000, 'Estudo Bíblico', 'Intermediário', true)
RETURNING id INTO curso_id_atual;
...
INSERT INTO public.cursos (nome, descricao, status, pontos_xp_recompensa, categoria, nivel, ativo)
VALUES ('Curso de Batismo: Mergulhando na Nova Vida', 'Um curso preparatório completo sobre o significado e a importância do batismo, conforme as doutrinas batistas.', 'publicado', 300, 'Preparação', 'Básico', true)
RETURNING id INTO curso_id_atual;
...
INSERT INTO public.cursos (nome, descricao, status, pontos_xp_recompensa, categoria, nivel, ativo)
VALUES ('DNA Kerigma: Nossa Identidade', 'Estrutura para os cursos do DNA da igreja. [Conteúdo a ser inserido pela liderança, com a devida permissão, se aplicável]', 'rascunho', 600, 'DNA', 'Todos os Níveis', true)
RETURNING id INTO curso_id_atual;
