...
BEGIN
    ...
    VALUES ('Como Estudar a Bíblia', 'Aprenda métodos práticos para aprofundar seu conhecimento e relacionamento com Deus através da Palavra.', 'publicado', 500, true, true, 'iniciante', 'estudo_biblico')
